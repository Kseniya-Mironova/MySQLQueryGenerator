...
public class UpdateTableStatement {
    ...
    public UpdateTableStatement(Connection connection, Object object, String[] updateColumnNames, String whereExpr, Object[] whereValues, String tableName) {
    ...
    public UpdateTableStatement(Connection connection, Object object, String[] updateColumnNames, String whereExpr, Object[] whereValues) {
        this(connection, object, updateColumnNames, whereExpr, whereValues, null);
    }

    private String generateUpdateQuery() throws IllegalAccessException, NotNullColumnHasNullValueException {
        String tableName = (_tableName == null) || (_tableName.isEmpty()) ? Table.getTableName(className) : _tableName;
            ...
            if ((Modifier.isPublic(modifiers)) && (!Modifier.isStatic(modifiers)) && (!field.isAnnotationPresent(DoNotCreateNotInsert.class)))
            {
                ...
                if ((column != null) &&
                    ...
                    if ((column.isNotNull) && (value == null)) {
                        throw new NotNullColumnHasNullValueException("Поле не может содержать пустые значения!");
                    }
    ...
    public PreparedStatement toPreparedStatement() throws MySQLException {
        try {
